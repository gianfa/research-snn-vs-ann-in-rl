...
# from src_19 import funx, synapse, topologies, visualization
...
RUN_PREFIX = f'14-trial11-50n-quant-3'
...
EXP_OUTPUT_DIR = EXP_DATA_DIR/"experiments"
RUN_OUTPUT_DIR = EXP_OUTPUT_DIR/run_name
...
ek.funx.yaml_save_dict(RUN_OUTPUT_DIR/"params.pkl", params)

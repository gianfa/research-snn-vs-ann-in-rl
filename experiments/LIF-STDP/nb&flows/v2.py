# %%
""" [INDEVELOPMENT] STDP Implementation trials, on LIFs

NOTES
-----
This exp is not ready yet
...
from sklearn.metrics import (
    accuracy_score, precision_score, f1_score, confusion_matrix  # noqa
)
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        # Record the layers step
        #    These will collect the spiking history only for this forward step

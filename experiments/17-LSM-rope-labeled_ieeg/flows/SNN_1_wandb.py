...
# from src_17 import funx, synapse, topologies, visualization
...
RUN_PREFIX = f'17-ieeg-trial3-clippedI-delta_enc'
data_path = EXP_DATA_DIR/"ieeg-toy-ds.pkl"
...
def wandb_main():
    ...
    input_size = 1
    reservoir_size = int(config['net_reservoir_size'])
    output_size = 3
    ...
    loss_scope = int(config['training_loss_scope'])
    eval_scope = loss_scope

    buffer_capacity = int(config['training_buffer_capacity'])
    ...
    washout_time = int(config['training_washout_time'])

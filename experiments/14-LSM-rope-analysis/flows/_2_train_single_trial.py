...
RUN_PREFIX = f'14-topol-trial5-s50-r16_-d2-quant3-delta_enc'
# RUN_PREFIX = f'trash'
...
yi_pred_buffer_test = src_14.funx.FIFO_buffer(capacity=buffer_capacity)
yi_pred_logits_buffer_test = src_14.funx.FIFO_buffer(capacity=buffer_capacity)
yi_buffer_test = src_14.funx.FIFO_buffer(capacity=buffer_capacity)
...
fname = RUN_REPORT_DIR/"loss_test.png"
fig.savefig(fname)
# %%
...
ax.set_xlabel("iteration/dw")
fname = RUN_REPORT_DIR/"accuracy_test.png"
fig.savefig(fname)

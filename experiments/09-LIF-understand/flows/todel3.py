...
net = Net(
    ...
    hidden_size=config['hidden_size']['values'][0],
    output_size=y_train_mb.shape[-1],
    inner_steps=config['inner_steps']['values'][0],
    beta1=config['beta1']['values'][0],
    beta2=config['beta2']['values'][0],
    )

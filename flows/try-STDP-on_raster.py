""" STDP Implementation trials

Short description
-----------------
Implementing a more traditional STDP algorithm based on traces.

For the implementation proof you can jump directly to the "IMPLEMENTATION" 
section in the code.
...
Allows the STDP to be calculated by considering:
- bidirectional synapses
- (sum_all) sum of changes exerted between each spike of a neuron and all
    others with of other neurons
- (nearest_spike) variation exerted only between pairs of spikes
    (pre/post synaptic).

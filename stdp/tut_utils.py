"""
ref: https://colab.research.google.com/github/jeshraghian/snntorch/blob/master/examples/tutorial_3_feedforward_snn.ipynb#scrollTo=2kBGXe5K_xWh
"""
...
def plot_cur_mem_spk(
    cur, mem, spk, thr_line=False,
    vline=False, title=False, ylim_max1=0.4,
    ylim_max2=1.25
):
    # Generate Plots
    fig, ax = plt.subplots(
